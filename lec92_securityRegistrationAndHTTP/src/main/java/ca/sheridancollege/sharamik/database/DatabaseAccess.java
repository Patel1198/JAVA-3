package ca.sheridancollege.sharamik.database;
...
import ca.sheridancollege.sharamik.beans.User;
...
public class DatabaseAccess {
	...
	public List<String> getRolesById(Long userId) {
		ArrayList<String> roles = new ArrayList<String>();MapSqlParameterSource parameters = new MapSqlParameterSource();
